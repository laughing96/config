...
# air.sh {
	...
	TMUX_POWERLINE_SEG_AIR_LAT="31.230001"
	TMUX_POWERLINE_SEG_AIR_LON="121.474000"
...
# date.sh {
	...
	export TMUX_POWERLINE_SEG_DATE_FORMAT="%m-%d %a %H:%M %j"
# }
...
# mailcount.sh {
	...
	export TMUX_POWERLINE_SEG_MAILCOUNT_MAILDIR_INBOX="/home/lucky/.mail/inbox/new"
	...
	export TMUX_POWERLINE_SEG_MAILCOUNT_MAILCHECKRC="/home/lucky/.mailcheckrc"
# }
...
# now_playing.sh {
	...
	# export TMUX_POWERLINE_SEG_NOW_PLAYING_TRACK_LOG_FILEPATH="/home/lucky/.now_playing.log"
...
# tmux_mem_cpu_load.sh {
	...
	# See https://github.com/thewtex/tmux-mem-cpu-load for all available options.
	 export TMUX_POWERLINE_SEG_TMUX_MEM_CPU_LOAD_ARGS="-q -v -l 52 -r 33"
# }
...
# weather.sh {
	...
	TMUX_POWERLINE_SEG_WEATHER_LAT="31.230001"
	TMUX_POWERLINE_SEG_WEATHER_LON="121.474000"
# }
